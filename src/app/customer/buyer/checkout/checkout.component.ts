  ...
  placeOrder(){
    this.order_dto ={
      ...
      product:{
        ...
        price:this.individual_product.price,
        quantity:this.individual_product.quantity,
        description:this.individual_product.description,
        imagePath:this.individual_product.imagePath,
        isLowStock:this.individual_product.isLowStock,
        category:this.individual_product.category, 
        addedToCart:this.individual_product.addedToCart,
        colors:this.individual_product.colors,
        inStock:this.individual_product.inStock,
        reviews:this.individual_product.reviews
      },
      deliveryAddress:{
        id:0,
