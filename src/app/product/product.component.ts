...
export class ProductComponent implements OnInit{
  ...
  addNewProduct(){
    ...
    this.product_dto = {
      ...
      price:this.prouct_data.price,
      quantity:this.prouct_data.quantity,
  description:this.prouct_data.description,
  imagePath:this.prouct_data.imagePath,
  isLowStock:this.prouct_data.isLowStock,
  category:this.prouct_data.category, 
  addedToCart:this.prouct_data.addedToCart,
  colors:this.prouct_data.colors,
  inStock:this.prouct_data.inStock,
  reviews:this.prouct_data.reviews
    }
